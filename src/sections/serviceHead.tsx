...
const ServiceHead: React.FC = () => (
  <section className="h-[20vh] bg-white flex flex-col items-center justify-center px-4 text-center">
    <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold bg-gradient-to-r from-[#010a14] to-[#020b72] bg-clip-text text-transparent">Our Services</h2>
    <motion.div
